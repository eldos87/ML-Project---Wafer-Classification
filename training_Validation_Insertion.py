...
class train_validation:
    ...
    def train_validation(self):  # 2 folders (good data / bad data) will be created. good data insert to db.
        ...
        try:
            ...
            # get the regex defined to validate filename
            regex = self.raw_data.manualRegexCreation()
            # validate filename of prediction files
