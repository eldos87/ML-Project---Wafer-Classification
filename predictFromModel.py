...
class prediction:
    ...
    def predictionFromModel(self):
        ...
        try:
            self.pred_data_val.deletePredictionFile()  # delete existing prediction file from last run
            ...
            clusters = kmeans.predict(data.drop(['Wafer'], axis=1))  # drop first column for cluster prediction
